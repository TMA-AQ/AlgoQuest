...
WHERE   
	...
	AND b.seq_sem_court = w.seq_sem_court
	AND b.seq_produit = w.seq_produit
	AND b.seq_indicateur = w.seq_indicateur
	AND b.seq_cbp_histo = w.seq_cbp_histo
	AND b.seq_caf_histo = w.seq_caf_histo;
